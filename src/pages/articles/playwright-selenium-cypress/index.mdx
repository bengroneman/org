...
submit_btn.click()
```
As you can see the Selenium implementation shown above requires over twice the amount of code, and brings along some complexity, and makes assumptions about the ID's presented on the page.
